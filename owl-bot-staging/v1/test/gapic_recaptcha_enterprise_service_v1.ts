...
describe('v1.RecaptchaEnterpriseServiceClient', () => {
    ...
    describe('createAssessment', () => {
        it('invokes createAssessment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateAssessmentRequest', ['parent']);
    ...
    describe('annotateAssessment', () => {
        it('invokes annotateAssessment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AnnotateAssessmentRequest', ['name']);
    ...
    describe('createKey', () => {
        it('invokes createKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateKeyRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getKey', () => {
        it('invokes getKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetKeyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.recaptchaenterprise.v1.Key()
    ...
    describe('updateKey', () => {
        it('invokes updateKey without error', async () => {
            ...
            request.key ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateKeyRequest', ['key', 'name']);
    ...
    describe('deleteKey', () => {
        it('invokes deleteKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteKeyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('migrateKey', () => {
        it('invokes migrateKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('MigrateKeyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.recaptchaenterprise.v1.Key()
    ...
    describe('getMetrics', () => {
        it('invokes getMetrics without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetMetricsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listKeys', () => {
        it('invokes listKeys without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListKeysRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listRelatedAccountGroups', () => {
        it('invokes listRelatedAccountGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListRelatedAccountGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listRelatedAccountGroupMemberships', () => {
        it('invokes listRelatedAccountGroupMemberships without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListRelatedAccountGroupMembershipsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('searchRelatedAccountGroupMemberships', () => {
        it('invokes searchRelatedAccountGroupMemberships without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SearchRelatedAccountGroupMembershipsRequest', ['project']);
