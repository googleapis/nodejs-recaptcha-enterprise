...
describe('v1.RecaptchaEnterpriseServiceClient', () => {
    ...
    describe('createAssessment', () => {
        it('invokes createAssessment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.recaptchaenterprise.v1.CreateAssessmentRequest', ['parent']);
        ...
        it('invokes createAssessment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createAssessment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.recaptchaenterprise.v1.IAssessment|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('annotateAssessment', () => {
        it('invokes annotateAssessment without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.recaptchaenterprise.v1.AnnotateAssessmentRequest', ['name']);
        ...
        it('invokes annotateAssessment without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.annotateAssessment(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.recaptchaenterprise.v1.IAnnotateAssessmentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createKey', () => {
        it('invokes createKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.recaptchaenterprise.v1.CreateKeyRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.createKey as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.createKey as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes createKey without error using callback', async () => {
            ...
            client.innerApiCalls.createKey = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createKey(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.recaptchaenterprise.v1.IKey|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getKey', () => {
        it('invokes getKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.recaptchaenterprise.v1.GetKeyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.recaptchaenterprise.v1.Key()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getKey as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getKey as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getKey without error using callback', async () => {
            ...
            client.innerApiCalls.getKey = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getKey(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.recaptchaenterprise.v1.IKey|null) => {
    ...
    describe('updateKey', () => {
        it('invokes updateKey without error', async () => {
            ...
            request.key ??= {};
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.recaptchaenterprise.v1.UpdateKeyRequest', ['key', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.updateKey as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.updateKey as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes updateKey without error using callback', async () => {
            ...
            client.innerApiCalls.updateKey = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updateKey(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.recaptchaenterprise.v1.IKey|null) => {
    ...
    describe('deleteKey', () => {
        it('invokes deleteKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.recaptchaenterprise.v1.DeleteKeyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.deleteKey as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.deleteKey as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes deleteKey without error using callback', async () => {
            ...
            client.innerApiCalls.deleteKey = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.deleteKey(
                    request,
    ...
    describe('migrateKey', () => {
        it('invokes migrateKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.recaptchaenterprise.v1.MigrateKeyRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.recaptchaenterprise.v1.Key()
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.migrateKey as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.migrateKey as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes migrateKey without error using callback', async () => {
            ...
            client.innerApiCalls.migrateKey = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.migrateKey(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.recaptchaenterprise.v1.IKey|null) => {
        ...
        it('invokes migrateKey with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.migrateKey = stubSimpleCall(undefined, expectedError);
    ...
    describe('getMetrics', () => {
        it('invokes getMetrics without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.recaptchaenterprise.v1.GetMetricsRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.getMetrics as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.getMetrics as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes getMetrics without error using callback', async () => {
            ...
            client.innerApiCalls.getMetrics = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getMetrics(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.recaptchaenterprise.v1.IMetrics|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes getMetrics with error', async () => {
            ...
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.getMetrics = stubSimpleCall(undefined, expectedError);
    ...
    describe('listKeys', () => {
        it('invokes listKeys without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.recaptchaenterprise.v1.ListKeysRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.recaptchaenterprise.v1.Key()),
              generateSampleMessage(new protos.google.cloud.recaptchaenterprise.v1.Key()),
              generateSampleMessage(new protos.google.cloud.recaptchaenterprise.v1.Key()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listKeys as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listKeys as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listKeys without error using callback', async () => {
            ...
            client.innerApiCalls.listKeys = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listKeys(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.recaptchaenterprise.v1.IKey[]|null) => {
        ...
        it('invokes listKeysStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.recaptchaenterprise.v1.Key) => {
            ...
            assert((client.descriptors.page.listKeys.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listKeys, request));
            assert(
        ...
        it('invokes listKeysStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listKeys.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listKeysStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.recaptchaenterprise.v1.Key[] = [];
                stream.on('data', (response: protos.google.cloud.recaptchaenterprise.v1.Key) => {
        ...
        it('uses async iteration with listKeys without error', async () => {
            ...
            client.descriptors.page.listKeys.asyncIterate = stubAsyncIterationCall(expectedResponse);
        ...
        it('uses async iteration with listKeys with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listKeys.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listKeysAsync(request);
    ...
    describe('listRelatedAccountGroups', () => {
        it('invokes listRelatedAccountGroups without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.recaptchaenterprise.v1.ListRelatedAccountGroupsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroup()),
              generateSampleMessage(new protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroup()),
              generateSampleMessage(new protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroup()),
            ];
            client.innerApiCalls.listRelatedAccountGroups = stubSimpleCall(expectedResponse);
            const [response] = await client.listRelatedAccountGroups(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listRelatedAccountGroups as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRelatedAccountGroups as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listRelatedAccountGroups without error using callback', async () => {
            ...
            client.innerApiCalls.listRelatedAccountGroups = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listRelatedAccountGroups(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.recaptchaenterprise.v1.IRelatedAccountGroup[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listRelatedAccountGroups with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listRelatedAccountGroups = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listRelatedAccountGroups(request), expectedError);
            const actualRequest = (client.innerApiCalls.listRelatedAccountGroups as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRelatedAccountGroups as SinonStub)
        ...
        it('invokes listRelatedAccountGroupsStream without error', async () => {
            ...
            client.descriptors.page.listRelatedAccountGroups.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroup) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listRelatedAccountGroups.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listRelatedAccountGroups, request));
            assert(
                (client.descriptors.page.listRelatedAccountGroups.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listRelatedAccountGroupsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRelatedAccountGroups.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listRelatedAccountGroupsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroup[] = [];
                stream.on('data', (response: protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroup) => {
        ...
        it('uses async iteration with listRelatedAccountGroups without error', async () => {
            ...
            client.descriptors.page.listRelatedAccountGroups.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listRelatedAccountGroups.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listRelatedAccountGroups.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listRelatedAccountGroups with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRelatedAccountGroups.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listRelatedAccountGroupsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.recaptchaenterprise.v1.IRelatedAccountGroup[] = [];
                for await (const resource of iterable) {
    ...
    describe('listRelatedAccountGroupMemberships', () => {
        it('invokes listRelatedAccountGroupMemberships without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.recaptchaenterprise.v1.ListRelatedAccountGroupMembershipsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroupMembership()),
              generateSampleMessage(new protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroupMembership()),
              generateSampleMessage(new protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroupMembership()),
            ];
            client.innerApiCalls.listRelatedAccountGroupMemberships = stubSimpleCall(expectedResponse);
            const [response] = await client.listRelatedAccountGroupMemberships(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.listRelatedAccountGroupMemberships as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRelatedAccountGroupMemberships as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes listRelatedAccountGroupMemberships without error using callback', async () => {
            ...
            client.innerApiCalls.listRelatedAccountGroupMemberships = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listRelatedAccountGroupMemberships(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.recaptchaenterprise.v1.IRelatedAccountGroupMembership[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listRelatedAccountGroupMemberships with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.innerApiCalls.listRelatedAccountGroupMemberships = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listRelatedAccountGroupMemberships(request), expectedError);
            const actualRequest = (client.innerApiCalls.listRelatedAccountGroupMemberships as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.listRelatedAccountGroupMemberships as SinonStub)
        ...
        it('invokes listRelatedAccountGroupMembershipsStream without error', async () => {
            ...
            client.descriptors.page.listRelatedAccountGroupMemberships.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroupMembership) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listRelatedAccountGroupMemberships.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listRelatedAccountGroupMemberships, request));
            assert(
                (client.descriptors.page.listRelatedAccountGroupMemberships.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes listRelatedAccountGroupMembershipsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRelatedAccountGroupMemberships.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listRelatedAccountGroupMembershipsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroupMembership[] = [];
                stream.on('data', (response: protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroupMembership) => {
        ...
        it('uses async iteration with listRelatedAccountGroupMemberships without error', async () => {
            ...
            client.descriptors.page.listRelatedAccountGroupMemberships.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listRelatedAccountGroupMemberships.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.listRelatedAccountGroupMemberships.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with listRelatedAccountGroupMemberships with error', async () => {
            ...
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.listRelatedAccountGroupMemberships.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listRelatedAccountGroupMembershipsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.recaptchaenterprise.v1.IRelatedAccountGroupMembership[] = [];
                for await (const resource of iterable) {
    ...
    describe('searchRelatedAccountGroupMemberships', () => {
        it('invokes searchRelatedAccountGroupMemberships without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('.google.cloud.recaptchaenterprise.v1.SearchRelatedAccountGroupMembershipsRequest', ['project']);
            ...
            client.innerApiCalls.searchRelatedAccountGroupMemberships = stubSimpleCall(expectedResponse);
            const [response] = await client.searchRelatedAccountGroupMemberships(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = (client.innerApiCalls.searchRelatedAccountGroupMemberships as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchRelatedAccountGroupMemberships as SinonStub)
                .getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        ...
        it('invokes searchRelatedAccountGroupMemberships without error using callback', async () => {
            ...
            client.innerApiCalls.searchRelatedAccountGroupMemberships = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes searchRelatedAccountGroupMemberships with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.searchRelatedAccountGroupMemberships = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.searchRelatedAccountGroupMemberships(request), expectedError);
            const actualRequest = (client.innerApiCalls.searchRelatedAccountGroupMemberships as SinonStub)
                .getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = (client.innerApiCalls.searchRelatedAccountGroupMemberships as SinonStub)
        ...
        it('invokes searchRelatedAccountGroupMembershipsStream without error', async () => {
            ...
            client.descriptors.page.searchRelatedAccountGroupMemberships.createStream = stubPageStreamingCall(expectedResponse);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.searchRelatedAccountGroupMemberships.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.searchRelatedAccountGroupMemberships, request));
            assert(
                (client.descriptors.page.searchRelatedAccountGroupMemberships.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
                        expectedHeaderRequestParams
                    )
            );
        ...
        it('invokes searchRelatedAccountGroupMembershipsStream with error', async () => {
            ...
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchRelatedAccountGroupMemberships.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.searchRelatedAccountGroupMembershipsStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroupMembership[] = [];
                stream.on('data', (response: protos.google.cloud.recaptchaenterprise.v1.RelatedAccountGroupMembership) => {
        ...
        it('uses async iteration with searchRelatedAccountGroupMemberships without error', async () => {
            ...
            client.descriptors.page.searchRelatedAccountGroupMemberships.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.recaptchaenterprise.v1.IRelatedAccountGroupMembership[] = [];
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.searchRelatedAccountGroupMemberships.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert(
                (client.descriptors.page.searchRelatedAccountGroupMemberships.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(
        ...
        it('uses async iteration with searchRelatedAccountGroupMemberships with error', async () => {
            ...
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedError = new Error('expected');
            client.descriptors.page.searchRelatedAccountGroupMemberships.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.searchRelatedAccountGroupMembershipsAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.recaptchaenterprise.v1.IRelatedAccountGroupMembership[] = [];
                for await (const resource of iterable) {
    ...
    describe('Path templates', () => {
        ...
        describe('metrics', () => {
            ...
            client.initialize();
            client.pathTemplates.metricsPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.metricsPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('metricsPath', () => {
                const result = client.metricsPath("projectValue", "keyValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.metricsPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromMetricsName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.metricsPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        ...
        describe('relatedAccountGroup', () => {
            ...
            client.initialize();
            client.pathTemplates.relatedAccountGroupPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.relatedAccountGroupPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('relatedAccountGroupPath', () => {
                const result = client.relatedAccountGroupPath("projectValue", "relatedaccountgroupValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.relatedAccountGroupPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });
            ...
            it('matchProjectFromRelatedAccountGroupName', () => {
                ...
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.relatedAccountGroupPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchRelatedaccountgroupFromRelatedAccountGroupName', () => {
                const result = client.matchRelatedaccountgroupFromRelatedAccountGroupName(fakePath);
        ...
        describe('relatedAccountGroupMembership', () => {
            ...
            it('relatedAccountGroupMembershipPath', () => {
                const result = client.relatedAccountGroupMembershipPath("projectValue", "relatedaccountgroupValue", "membershipValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.relatedAccountGroupMembershipPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromRelatedAccountGroupMembershipName', () => {
                const result = client.matchProjectFromRelatedAccountGroupMembershipName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.relatedAccountGroupMembershipPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchRelatedaccountgroupFromRelatedAccountGroupMembershipName', () => {
                const result = client.matchRelatedaccountgroupFromRelatedAccountGroupMembershipName(fakePath);
                assert.strictEqual(result, "relatedaccountgroupValue");
                assert((client.pathTemplates.relatedAccountGroupMembershipPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
            ...
            it('matchMembershipFromRelatedAccountGroupMembershipName', () => {
                const result = client.matchMembershipFromRelatedAccountGroupMembershipName(fakePath);
