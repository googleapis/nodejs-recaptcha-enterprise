...
export class RecaptchaEnterpriseServiceClient {
  ...
  initialize() {
    ...
    const recaptchaEnterpriseServiceStubMethods =
        ['createAssessment', 'annotateAssessment', 'createKey', 'listKeys', 'getKey', 'updateKey', 'deleteKey', 'migrateKey', 'getMetrics', 'listRelatedAccountGroups', 'listRelatedAccountGroupMemberships', 'searchRelatedAccountGroupMemberships'];
