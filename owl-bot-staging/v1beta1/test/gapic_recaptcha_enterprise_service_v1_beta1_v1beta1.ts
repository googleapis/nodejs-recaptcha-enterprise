...
describe('v1beta1.RecaptchaEnterpriseServiceV1Beta1Client', () => {
    ...
    describe('createAssessment', () => {
        it('invokes createAssessment without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.recaptchaenterprise.v1beta1.Assessment());
    ...
    describe('annotateAssessment', () => {
        it('invokes annotateAssessment without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.recaptchaenterprise.v1beta1.AnnotateAssessmentResponse());
    ...
    describe('createKey', () => {
        it('invokes createKey without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.recaptchaenterprise.v1beta1.Key());
        ...
        it('invokes createKey without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createKey(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.recaptchaenterprise.v1beta1.IKey|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listKeys', () => {
        ...
        it('invokes listKeysStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.recaptchaenterprise.v1beta1.Key[] = [];
                stream.on('data', (response: protos.google.cloud.recaptchaenterprise.v1beta1.Key) => {
